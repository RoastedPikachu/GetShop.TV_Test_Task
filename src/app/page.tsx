  ...
  return (
    <main className="relative w-[1280px] h-[720px]">
      ...
      <div className="relative w-full h-full">
        ...
        {/*    width="1280"*/}
        {/*    height="720"*/}
        {/*    src="https://www.youtube.com/embed/M7FIvfx5J10?si=q_LvnDNNmY05TBJc&autoplay=1&rel=0&playlist=M7FIvfx5J10&controls=0&loop=1&mute=1&cc_load_policy=0&iv_load_policy=3"*/}
